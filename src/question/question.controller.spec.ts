...
describe('QuestionController', () => {
 ...
 const createQuestionDto: CreateQuestionDto = {
  ...
  beforeEach(async () => {
    ...
    }).overrideProvider(QuestionService).useValue(mockQuestionService).compile();
  ...
  describe("create", () => {
		it("should create an applicant", async () => {
			...
			const result = await controller.create(createdQuestion);
  ...
  describe('findByCategory', () => {
    it('should call findByCategory in the service with the provided category', () => {
      const category = TypeCategory.Personal; 

      controller.findByCategory(category);
