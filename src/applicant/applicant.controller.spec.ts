...
import { TipoAccessoInternetDispositivos, TipoEducacion, TipoEncontrarPrograma, TipoGenero, TipoId, TipoInteresesActuales, TipoProgramaDeseado, TipoSituacionProfesional } from "./entities/applicant.enums";
