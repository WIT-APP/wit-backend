...
export class ApplicantService {
  ...
  `;
    ...
    try {
      ...
      RETURNING *;
    `;
      const updatedApplicants = await this.applicantRepository.query(
        updateQuery,
      );
  ...
  async updateEstado(
    ...
    try {
      ...
      throw new InternalServerErrorException(
        'Occurrió un error actualizando el aspirante.',
      );
    }
  }
  ...
  async updateApplicant(
    ...
    try {
      ...
      applicant.situacion_profesional =
        updateApplicantDto.situacion_profesional;
